...
GITHUB_BASE_URL = "https://github.com/rhyslwells/notebook-explorer/blob/main/notebooks"
...
for path, meta in filtered_metadata.items():
    with st.expander(meta["title"]):
        ...
        colab_url = f"https://colab.research.google.com/github/rhyslwells/notebook-explorer/blob/main/notebooks/{path}"
